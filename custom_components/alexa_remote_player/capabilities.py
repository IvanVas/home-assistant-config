...
class AlexaLauncher(AlexaCapability):
    """Implements Alexa.Launcher.

    https://developer.amazon.com/en-US/docs/alexa/device-apis/alexa-launcher.html
    """
...
class AlexaRemoteVideoPlayer(AlexaCapability):
    """Implements Alexa.AlexaRemoteVideoPlayer.

    https://developer.amazon.com/en-US/docs/alexa/device-apis/alexa-remotevideoplayer.html
    """
